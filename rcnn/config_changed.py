...
config.TRAIN.RPN_PRE_NMS_TOP_N = 1200
...
config.TEST.RPN_PRE_NMS_TOP_N = 600
config.TEST.RPN_POST_NMS_TOP_N = 30
...
config.TEST.PROPOSAL_PRE_NMS_TOP_N = 2000
config.TEST.PROPOSAL_POST_NMS_TOP_N = 200
